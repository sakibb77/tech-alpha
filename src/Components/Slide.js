  ...
  return (
    ...
    >
      <div className="slide-text container mx-auto text-violet-50 flex flex-col items-center lg:items-start justify-center h-full gap-5">
        <h1 className="text-2xl text-center md:text-start md:text-5xl lg:text-7xl w-4/5 font-bold uppercase space-font">
          {slide.headline}
        </h1>
        <p className="w-4/5 lg:w-3/5 text-center md:text-start ">
          {slide.body}
        </p>
        <Link
